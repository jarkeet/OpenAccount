package com.anychat.aiselfrecordcompontsdemo.utils.net;
...
//        mHttpClient = new OkHttpClient();
     ...
     * @param callback
     */
    public void post(String url, Map<String,String> heads, String json, BaseCallback callback) {
        RequestBody body = RequestBody.create(mMediaType, json);
    ...
    private void doRequest(final Request request, final BaseCallback baseCallback) {
        Log.e("===HTTP Request===", request.toString());
        if (!EmptyUtils.isNullOrEmpty(request.toString())) {
            ...
            if ("POST".equals(method.toUpperCase())) {
                ...
                if (request.body() instanceof FormBody) {
                    ...
                    Log.e("===Request body===", sb.toString());
                } else {
                    Log.e("===Request body===", bodyToString(body));
                }
            }
        }
